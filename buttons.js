! function() {
    "use strict";
    var d, l, s, e, t, o, p = window.document,
        n = p.location,
    ...
    m = function(e, t) {
        ...
        var e, t, o, n, r, a, i;
        if (t = [], p.querySelectorAll) t = p.querySelectorAll("a." + l);
        else
            for (o = 0, r = (i = p.getElementsByTagName("a")).length; o < r; o++) ~(" " + (e = i[o]).className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" " + l + " ") && t.push(e);
        ...
        render: k
    }) : "object" == typeof exports && "string" != typeof exports.nodeName ? exports.render = k : (o && e(o.replace(/\/[^\/]*([?#].*)?$/, "")), n.protocol + "//" + n.host + n.pathname === d + s ? v(p.body, function(e) {
        var t, o, n, r, a, i;
